        ...
        <div class="modal-body">
          <div class="row">
            ...
            <div class="col-md-12 mb-3">
              ...
              <input type="number" class="form-control" name="precio_servicio" pattern="<?php echo regexPrecio ?>" minlength="<?php echo minRegexPrecio ?>" maxlength="<?php echo maxRegexPrecio ?>" required>
            </div>
          </div>
        </div>
        ...
        <div class="modal-body">
          <div class="row">
            ...
            <div class="col-md-12 mb-3">
              ...
              <input type="number" class="form-control formularioActualizar" name="precio_servicio" pattern="<?php echo regexPrecio ?>" minlength="<?php echo minRegexPrecio ?>" maxlength="<?php echo maxRegexPrecio ?>" required>
            </div>
          </div>
        </div>
        <div class="modal-footer justify-content-center" style="background-color: #f8f9fa;">
