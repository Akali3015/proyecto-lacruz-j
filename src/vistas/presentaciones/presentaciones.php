        ...
        <div class="modal-content border-0">
            <div class="modal-header text-white" style="background: linear-gradient(135deg, #4e54c8, #8f94fb);">
                <h5 class="modal-title" id="registrarUsuarioModalLabel">
                    <i class="fas fa-box-open me-2"></i> Registro de Nueva Presentación
                </h5>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-3">
                            <label class="form-label">ID de la Presentación</label>
                            <input type="text" class="form-control noRepetir" name="id_presentacion" pattern="<?php echo regexId ?>" minlength="<?php echo minRegexId ?>" maxlength="<?php echo maxRegexId ?>" required>
                        </div>
                        <div class="col-md-12 mb-3">
            ...
            <form class="formularioAjax validar" method="POST" action="" novalidate>
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-3">
                            <label class="form-label">ID de la Presentación</label>
                            <input type="text" name="id_presentacion" class="form-control noRepetir formularioActualizar" pattern="<?php echo regexId ?>" minlength="<?php echo minRegexId ?>" maxlength="<?php echo maxRegexId ?>" required readonly>
                        </div>
                        <div class="col-md-12 mb-3">
                            <label class="form-label">Nombre de la Presentación</label>
