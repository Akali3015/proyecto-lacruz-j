...
const listaCompletaModulos = [
  ...
  { id: 'compras', nombre: 'Recepciones', descripcion: 'Compras a proveedores', ruta: 'compras', permiso: 'compras' },
  ...
  { id: 'ordenesEntregasPresupuestos', nombre: 'Órdenes de Entrega', descripcion: 'Proceso de facturación', ruta: 'ordenesEntregasPresupuestos', permiso: 'ordenesEntregasPresupuestos' },
  { id: 'home', nombre: 'Inicio', descripcion: 'Vista principal del sistema', ruta: 'home', permiso: 'home' },
  ...
  { id: 'pagos', nombre: 'Pagos', descripcion: 'Gestión de pagos', ruta: 'pagos', permiso: 'pagos' },
